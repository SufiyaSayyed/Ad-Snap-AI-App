...
const pageTitles: Record<string, string> = {
  "/playground/hd-image": "Generative HD Images",
  "/playground/gen-fill": "Generative Fill",
  "/playground/erase-element": "Erase Elements",
  "/playground/replace-bg": "Replace Background",
};
